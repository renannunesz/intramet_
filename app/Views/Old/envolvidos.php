            ...
            <table class="table is-fullwidth is-hoverable is-striped ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href='Envolvidos/editar/<?php echo $envolvido['cod']; ?>'><button class="button" value="<?php echo $envolvido['cod']; ?>">Editar</button></a>
                            <a href='Envolvidos/apagar/<?php echo $envolvido['cod']; ?>'><button class="button" value="<?php echo $envolvido['cod']; ?>">Apagar</button></a>
                        </td>
