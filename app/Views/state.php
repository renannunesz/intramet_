                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <button type="button" class="btn btn-secondary btn-sm"><a class="dropdown-item" href='<?php echo base_url('public/Status'); ?>'>Cancelar</a></button>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" name="descricao" id="descricao" value='<?php echo isset($status['descricao']) ? $status['descricao'] : ''; ?>'>
                        </div>
